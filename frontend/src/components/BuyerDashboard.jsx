...
import { UserCircleIcon, ExclamationCircleIcon, CheckCircleIcon, InformationCircleIcon, HomeIcon, BellIcon } from '@heroicons/react/24/solid'
...
function BuyerDashboard() {
    ...
    notifications: [
      {
        ...
        message: 'Please verify your identification documents to proceed with the property purchase.',
        urgent: true,
        date: '2024-03-20',
        type: 'alert'
      },
      {
        id: 2,
        title: 'Survey Report Available',
        message: 'The property survey report is now available for your review.',
        urgent: true,
        date: '2024-03-19',
        type: 'info'
      },
      {
        id: 3,
        title: 'Mortgage Application Update',
        message: 'Your mortgage application has been approved. Please review the terms.',
        urgent: false,
        date: '2024-03-18',
        type: 'success'
      }
  ...
  const notificationIcon = (type) => {
    switch(type) {
      case 'alert':
        return <ExclamationCircleIcon className="w-6 h-6 text-red-500 mr-3" />
      case 'success':
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 mb-10 flex items-center gap-6 border border-blue-100">
          ...
          <div>
            ...
            <p className="text-lg text-gray-500">
              Here's an overview of your property transactions
            </p>
          </div>
        </div>
