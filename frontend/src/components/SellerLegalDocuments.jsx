...
const LEGAL_DOCUMENTS = [
  { key: 'ta6_ta10_forms', label: 'TA6 / TA10 Forms' },
  { key: 'draft_contract', label: 'Draft Contract' },
];

function SellerLegalDocuments() {
      ...
      <div className="property-dashboard-content">
        <div className="documents-section">
          <div className="section-header">
            ...
            <p>Upload your TA6/TA10 forms and draft contract for your solicitor</p>
          </div>
...
export default SellerLegalDocuments; 