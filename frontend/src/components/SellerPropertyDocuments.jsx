...
const PROPERTY_DOCUMENTS = [
  { key: 'epc', label: 'EPC (Energy Performance Certificate)' },
  { key: 'title_plan', label: 'Title Plan' },
  { key: 'property_photos', label: 'Property Photos' },
];

function SellerPropertyDocuments() {
      ...
      <div className="property-dashboard-content">
        <div className="documents-section">
          <div className="section-header">
            ...
            <p>Upload EPC, title plan, and property photos for your property</p>
          </div>
...
export default SellerPropertyDocuments; 