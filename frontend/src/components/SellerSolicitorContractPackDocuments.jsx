...
const CONTRACT_PACK_DOCUMENTS = [
  { key: 'draft_contract', label: 'Draft Contract', section: 'Contract Pack', uploadedBy: 'Solicitor' },
  { key: 'title_register_plan', label: 'Title Register & Plan', section: 'Contract Pack', uploadedBy: 'Solicitor' },
  { key: 'ta6_ta10_forms', label: 'TA6 / TA10 Forms', section: 'Contract Pack', uploadedBy: 'Solicitor' },
  { key: 'epc', label: 'EPC', section: 'Contract Pack', uploadedBy: 'Solicitor' },
];

function SellerSolicitorContractPackDocuments() {
        ...
        <div className="documents-section">
          ...
          <div className="table-container">
            ...
            <table className="documents-table">
              ...
              <tbody>
                {CONTRACT_PACK_DOCUMENTS.map(doc => {
...
export default SellerSolicitorContractPackDocuments; 