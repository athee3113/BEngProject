...
const SEARCH_DOCUMENTS = [
  { key: 'local_authority_search', label: 'Local Authority Search', section: 'Searches', uploadedBy: 'Solicitor', expiryMonths: 6 },
  { key: 'water_drainage', label: 'Water & Drainage', section: 'Searches', uploadedBy: 'Solicitor', expiryMonths: 6 },
  { key: 'environmental_search', label: 'Environmental Search', section: 'Searches', uploadedBy: 'Solicitor', expiryMonths: 6 },
];

function SellerSolicitorSearchesDocuments() {
...
export default SellerSolicitorSearchesDocuments; 